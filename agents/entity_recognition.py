...
NAME_TO_TICKER: dict[str, tuple[str, str]] = {
    ...
    "doordash": ("DASH", "Consumer Discretionary"), "door dash": ("DASH", "Consumer Discretionary"),
    "airbnb": ("ABNB", "Consumer Discretionary"), "instacart": ("CART", "Consumer Staples"),
    "waymo": ("GOOGL", "Communication Services"), "deepmind": ("GOOGL", "Communication Services"),
    "youtube": ("GOOGL", "Communication Services"), "android": ("GOOGL", "Communication Services"),
    "instagram": ("META", "Communication Services"), "whatsapp": ("META", "Communication Services"),
    "threads": ("META", "Communication Services"), "oculus": ("META", "Communication Services"),
    "aws": ("AMZN", "Consumer Discretionary"), "whole foods": ("AMZN", "Consumer Discretionary"),
    "azure": ("MSFT", "Technology"), "github": ("MSFT", "Technology"),
    "linkedin": ("MSFT", "Technology"), "bing": ("MSFT", "Technology"),
    "iphone": ("AAPL", "Technology"), "ipad": ("AAPL", "Technology"),
    "mac": ("AAPL", "Technology"), "app store": ("AAPL", "Technology"),
    "pixel": ("GOOGL", "Communication Services"), "chrome": ("GOOGL", "Communication Services"),
